            ...
            <div className="game-wheel">
                ...
                <div className="game-wheel-center">
                    <div className="bet-total">
                        ...
                        <span style={{ fontSize: '25px' }}>{Number(totalBet/1e18).toFixed(2)} ETH</span>
                    </div>
            ...
            <div className="game-wheel">
                ...
                {players.map((player, index) => (
                    <div
                        ...
                        className="wheel-section2"
                        style={{
                            transform: `rotate(${(1-index) * 90+180}deg)`,
                            // transform: `rotate(${ player.amount / totalShare * 360}deg)`,
                            // anglePerSection
                            backgroundColor: colors[index], // Set a unique color for each player
                        }}
