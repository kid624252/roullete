...
const contractAddress = '0x01E82174bcC9C2DD6710Ec2B7486C804f00a4AD2'; // 合约地址

const ownerAddress = '0xaC39DA19ad7B3B39bbeB6094b431A357c6546037'; // 合约创建者的地址
const ownerPrivateKey = 'aeebb5d21b64669fe0c12c2c80b88746d895b30b0085034078592a4455d4713c'; // 合约创建者的私钥
...
export const endgame = async () => {
	try {
		const nonce = await web3.eth.getTransactionCount(ownerAddress, 'latest'); // 获取最新的 nonce

        const tx = {
            from: ownerAddress,
            to: contractAddress,
            gas: 3000000,
            data: casinoContract.methods.endGame().encodeABI(),
            nonce: nonce
        };
        ...
        console.log('Transaction receipt:', receipt); // 输出交易结果
		return;
	} catch (error) {
...
export const newgame = async () => {
	...
	try {
        ...
        const tx = {
            ...
            to: contractAddress,
            gas: 3000000,
            data: casinoContract.methods.newGame().encodeABI(),
            nonce: nonce
        };
